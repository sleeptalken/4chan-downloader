#Edited 07/22/2018 -- converted from python 2to3 and other misc. changes when writing the img files
        ...
        try:
            ...
            for link, img in list(set(re.findall(regex, load(thread_link).decode('utf-8')))):
                ...
                if not os.path.exists(img_path):
                    ...
                    with open(img_path, 'wb') as f: #changed 'w' to 'wb'
                        f.write(data)
                    ...
                    with open(copy_path, 'wb') as f: #changed 'w' to 'wb'
                        f.write(data)
